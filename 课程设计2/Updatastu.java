...
public class Updatastu extends JPanel implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(obj==查找){if(学号1.getText().equals(""))JOptionPane.showMessageDialog(this,"请填写查询的学号！" );
            ...
            sql1="select * from student.s where Sno='"+学号1.getText()+"'";
            try{
            ...
            if(obj==修改){if(save==null){JOptionPane.showMessageDialog(this,"还没查找需要修改的学生" );}
                ...
                if(学号.getText().equals("")||姓名.getText().equals("")||系别.getText().equals("")){
                ...
                else{sql="update student.s set Sno='"+学号.getText()+"',Sname='"+姓名.getText()+"',Sx='"+系别.getText()+"'"+"where Sno='"+save+"'";
                    ...
                    else{sql1="select * from student.s where Sno='"+学号.getText()+"'";
                        try{
                            Connection dbConn1=CONN();
                            stmt=(Statement)dbConn1.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                            rs1=stmt.executeQuery(sql1);
                            if(rs1.next()){  	JOptionPane.showMessageDialog(this,"已存在此学号学生" );
                                ...
                                sqlSC="update student.sc set Sno='"+学号.getText()+"' where Sno='"+save+"'";
                                stmt.executeUpdate(sql);
