...
public class UpdateC extends JPanel implements ActionListener{
    ...
    public void actionPerformed(ActionEvent e){
        ...
        if(obj==查找){if(课号1.getText().equals(""))JOptionPane.showMessageDialog(this,"请填写查询的课号！" );
            ...
            sql1="select * from student.c where Cno='"+课号1.getText()+"'";
            try{
            ...
            if(obj==修改){if(save==null){JOptionPane.showMessageDialog(this,"还没查找需要修改的课程" );}
                ...
                if(课号.getText().equals("")||课名.getText().equals("")){
                ...
                else{sql="update student.c set Cno='"+课号.getText()+"',Cname='"+课名.getText()+"' where Cno='"+save+"'";
                    ...
                    else{sql1="select * from student.c where Cno='"+课号.getText()+"'";
                        try{
                            Connection dbConn1=CONN();
                            stmt=(Statement)dbConn1.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
                            rs1=stmt.executeQuery(sql1);
                            ...
                            else{sqlSC="update student.sc set Sno='"+课号.getText()+"' where Cno='"+save+"'";
                                stmt.executeUpdate(sql);
