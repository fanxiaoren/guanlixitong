        ...
        if(obj==查找){if(课号1.getText().equals("")||学号1.getText().equals(""))JOptionPane.showMessageDialog(this,"请填写完成查询的信息！" );
            ...
            if(obj==修改){if(saveC==null||saveS==null)JOptionPane.showMessageDialog(this,"还没查找需要修改的学生/课程" );
                ...
                if(课号.getText().equals("")||学号.getText().equals("")){
                    ...
                    sqlC="select * from student.c where Cno='"+课号.getText()+"'";
                    sqlS="select * from student.s where Sno='"+学号.getText()+"'";
                    sql1="select * from student.sc where Cno='"+课号.getText()+"' and Sno='"+学号.getText()+"'";
                    sql="update student.sc set Cno='"+课号.getText()+"',Sno='"+学号.getText()+"',C='"+成绩.getText()+"' where Cno='"+saveC+"' and Sno='"+saveS+"'";
                    try{
                        Connection dbConn1=CONN();
                        stmt=(Statement)dbConn1.createStatement(ResultSet.TYPE_SCROLL_INSENSITIVE,ResultSet.CONCUR_READ_ONLY);
